...
class GroqLLMCleaner:
    ...
    STYLE_PROMPTS = {
        ...
        "email": (
            ...
            "- Preserve content and intent. Do NOT invent facts, names, "
            "numbers, or details that were not in the input.\n"
            "- NEVER use em dashes (the character U+2014, also called "
            "'long dash'). If one would appear, replace it with a comma "
            "or a period.\n"
            "- Minimize standard hyphens used as sentence connectors. "
            "Prefer commas or periods.\n"
            "- NEVER use emojis under any circumstance.\n"
            "- Plain English over jargon. Avoid corporate buzzwords "
            "such as synergy, leverage, ecosystem, robust, seamless, "
            "holistic, paradigm, streamline. An average reader should "
            "understand the text without effort.\n"
            "- Professional but down to earth. Easy for the recipient "
            "to read.\n"
            "- Default tone: warm, clear, direct.\n"
